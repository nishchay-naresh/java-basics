...
public class InfiniteStreamDemo {
  ...
  public static void main(String[] args) {
    ...
    int k = 121;
    int n = 51;
    System.out.println(compute_itr(k, n));
    System.out.println(compute_stream(k, n));
  }

  public static int compute_stream(int k, int n) {
  ...
  public static int compute_itr(int k, int n) {
     int result = 0;

 ...
 *	3. Given s="a?b??aa" your function should return "aababaa" // aab??aa,abb??aa // aab??aa -aababaa //abb??aa-abbabaa,
 ...
 *
 * TODO - Case 3 is bit tricky one, Its combine both of the solved cases
...
public class Wells {
    ...
    public static void main(String[] args) {
        ...
        String[] inputs = new String[]{"a?bb", "??abb", "aa??aa"};
